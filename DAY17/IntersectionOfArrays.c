...
int main()
{
    ...
    printf("Intersection of arrays is: ");          // display message for intersection array
    for(i = 0; i < k; i++)              // loop to display the intersection array
    {
        printf("%d ", intersectionArr[i]);           // print each element followed by a space      
    }
